<script lang="ts">
  ...
  let link = "https://api.nasa.gov/planetary/apod?api_key=" + PUBLIC_NASA_API_KEY
...
<div class="util-center" style="background-image: url({data.hdurl});" in:fade={{duration:250}}>
  ...
  <div class="block">
    <div class="content">
      ...
      <div class="deets">
        <svg xmlns="http://www.w3.org/2000/svg" height="42" viewBox="0 0 110 92" width="60">
