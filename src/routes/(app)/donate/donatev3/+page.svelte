<script lang="ts">
  ...
  let activeAmountWorthHtml = `
            <div class="worth-list-holder">
              <ul class="worth-list">
                <li><span>☀️</span>A solar panel</li>
                <li><span>🧻</span>Latrine</li>
              </ul>
              <ul class="worth-list">
                <li><span>🐷</span>3 pigs</li>
                <li><span>🛌</span>Mattress</li>
                </ul>
            </div>
            `
    ...
    if (activePaymentInterval == "Monthly") {
        ...
        if (activeDollarAmount === "25") {
          ...
          activeAmountWorthHtml = `
            <div class="worth-list-holder">
              <ul class="worth-list">
                <li><span>🐔</span>6 chickens</li>
                <li><span>❤️‍🩹</span>A year of health insurance</li>
              </ul>
              <ul class="worth-list">
                <li><span>🏍️</span>10 mototaxi rides</li>
                <li><span>💈</span>Hair clippers for a barbershop business</li>
                </ul>
            </div>
            `
        }
          ...
          activeAmountWorthHtml = `
            <div class="worth-list-holder">
              <ul class="worth-list">
                <li><span>🌽</span>1 month of food for a family</li>
                <li><span>🛖</span>An iron sheet roof</li>
              </ul>
              <ul class="worth-list">
                <li><span>🧵</span>A sewing machine for a clothing business</li>
                <li><span>🐐</span>4 goats</li>
                </ul>
            </div>
            `
      ...
      if (activeDollarAmount === "50") {
        ...
        activeAmountWorthHtml = `
            <div class="worth-list-holder">
              ...
              <ul class="worth-list">
                <li><span>💧</span>2 water pumps</li>
                <li><span>🏍️</span>A motorcycle for a mototaxi business</li>
                </ul>
            </div>
            `
      } else if (activeDollarAmount === "Other") {
    ...
    <div class="inner top">
      ...
      <div class="form">
        <div class="form-inner">
          ...
          <!-- <div class="dedicate">
            <span>Dedicated this donation</span> <button class="question">?</button>
          </div> -->
