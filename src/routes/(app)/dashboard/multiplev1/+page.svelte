    ...
    <div class="monthly">
      ...
      {#if paymentSet}
        <div class="donate">
          ...
          {#if !donationPaused}
          <div class="payment-text-icon multiple">
      ...
      {#key bigDonation}
      <div class="donate warning" class:big={bigDonation} in:fade={{duration:250}}>
        <div class="settings-holder" in:fade={{duration:250}}>
        ...
        <div class="payment-text" in:fade={{duration:250}}>
          ...
          <div class="payment-text-reactivate">
            <button class="payment-text-reactivate-button" on:click={() => showModal = true}> 
              Update your card
            </button>
          </div>
        </div>
