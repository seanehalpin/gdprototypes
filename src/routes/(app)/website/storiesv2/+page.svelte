...
>
  <div class="holder">
    <div class="title">
      ...
      <div class="story-buttons-holder">
        <div class="story-buttons">
          {#each stories as story, i}
            <button class="story-button" class:active={currentStory === story} on:click={()=> currentStory = story}>{story.category}</button>
          {/each}
        </div>
      </div>
    </div>
  ...
  .story-buttons {
    ...
    .story-button {
      ...
      &.active {
        ...
        // box-shadow: 0 0 0 1px var(--border-tertiary), 0px 4px 4px 0px rgba(0, 0, 0, 0.04);
